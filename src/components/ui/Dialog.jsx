    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          ...
          'glass-card p-6 shadow-2xl duration-200',
          className
        )}
        {...props}
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-muted hover:text-foreground transition-colors">
          <X className="h-4 w-4" />
